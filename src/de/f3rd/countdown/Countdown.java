...
public class Countdown extends JavaPlugin
{
    ...
    public void onEnable()
    {
        ...
        ccs.sendMessage(ChatColor.GOLD + "[Countdown] wurde erfolgreich aktiviert.");
        ccs.sendMessage("[Countdown] by f3rd");
    }
    ...
    {
        ccs.sendMessage(ChatColor.RED + " [Countdown] wurde deaktiviert.");
    }
